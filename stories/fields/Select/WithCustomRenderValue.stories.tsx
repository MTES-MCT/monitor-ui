...
export function WithCustomRenderValue(props: SelectProps<string>) {
  const [outputValue, setOutputValue] = useState<string | undefined | '∅'>('∅')

  const { controlledOnChange, controlledValue } = useFieldControl(props.value, setOutputValue)

  const renderValue = (_, item) => (
    <>
      <Icon.Alert />
  ...
  return (
    <>
      <Select {...props} onChange={controlledOnChange} renderValue={renderValue} value={controlledValue} />
