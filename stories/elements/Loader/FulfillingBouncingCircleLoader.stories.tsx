...
const meta: Meta<LoaderProps> = {
  title: 'Elements/Loader/FulfillingBouncingCircleLoader',
  component: FulfillingBouncingCircleLoader,
...
export function _FulfillingBouncingCircleLoader(props: LoaderProps) {
  return (
    <div style={{ backgroundColor: THEME.color.gunMetal, padding: '20px', width: '150px' }}>
      <FulfillingBouncingCircleLoader {...props} />
    </div>
  )
}
