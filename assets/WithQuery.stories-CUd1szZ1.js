import{be as l,a as s,aJ as u,j as e,bf as S,aE as O,bg as V}from"./index-DOn5IH5D.js";import{k as v}from"./index-CMZNRRAH.js";import{r as a}from"./index-CBqU2yxZ.js";import{O as w}from"./Output-o7hVPfWS.js";import{g as Q}from"./StoryDecorator-CIMcLWSk.js";import"./isPlainObject-ByolnvGK.js";import"./_commonjsHelpers-BosuxZz1.js";import"./mapValues-y2Dgfp-9.js";import"./index-Ch9hqOxJ.js";import"./debounce-S-gaweFD.js";import"./_arrayIncludesWith-DoLrk8sb.js";import"./GlobalDecorator-DCTCzM4b.js";const j={isLabelHidden:!1,isLight:!1,label:"An autocompletable select",name:"autoComplete",placeholder:'Type "brew"'},J={title:"Formiks/FormikSearch",component:l,argTypes:{},args:j,decorators:[Q({hasDarkMode:!0})]},t=o=>{const[n,c]=a.useState("∅"),[d,y]=a.useState([]),b=async g=>{const r=await v.get(`https://api.openbrewerydb.org/breweries?by_name=${g}`).json(),h=r?r.map(({id:f,name:F})=>({label:F,value:f})):[];y(h)},k=a.useMemo(()=>o.name,[o.name]);return s(u,{children:[e(S,{initialValues:{},onSubmit:O.noop,children:s(u,{children:[e(V,{onChange:c}),e(l,{...o,onQuery:b,options:d})]})},k),n!=="∅"&&e(w,{value:n})]})};var i,p,m;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`(props: FormikSearchProps) => {
