import{bq as o,j as a}from"./index-0nDB5Zzz.js";import{r as p}from"./index-CBqU2yxZ.js";import{O}from"./Output-Sfj1QWTd.js";import{M as c,A as e}from"./constants-D7cOJi0A.js";import{g as f}from"./generateStoryDecorator-jcZX8bPx.js";import{F as b,a as T,b as g}from"./fake_options-pLn6bACZ.js";import"./_baseClone-CBkhujLI.js";import{u as y}from"./useFieldControl-oDxVSMc2.js";import"./isPlainObject-Dl0da9pc.js";import"./_commonjsHelpers-BosuxZz1.js";import"./mapValues-CZXAhdHD.js";import"./index-Ch9hqOxJ.js";import"./toNumber-BGTiNFDU.js";import"./StoryBox-BZYZ6up0.js";import"./fr_FR-CrxT__co.js";import"./fake_text-B6tiQCXj.js";const k={...c,title:"Fields/Select",component:o,argTypes:{customSearch:e.NO_CONTROL_INPUT,customSearchMinQueryLength:e.OPTIONAL_NUMBER_NO_CONTROL_INPUT,error:e.OPTIONAL_STRING,isCleanable:e.OPTIONAL_BOOLEAN,isErrorMessageHidden:e.OPTIONAL_BOOLEAN,isLabelHidden:e.OPTIONAL_BOOLEAN,isLight:e.OPTIONAL_BOOLEAN,isTransparent:e.OPTIONAL_BOOLEAN,isUndefinedWhenDisabled:e.OPTIONAL_BOOLEAN,options:e.NO_CONTROL_INPUT,optionValueKey:e.OPTIONAL_OPTION_VALUE_KEY,readOnly:e.OPTIONAL_BOOLEAN,searchable:e.BOOLEAN,value:{...e.OPTIONAL_OPTION_VALUE,options:[...b,void 0],mapping:{...T,undefined:void 0}}},args:{disabled:!1,error:"",customSearchMinQueryLength:1,isCleanable:!0,isErrorMessageHidden:!1,isLabelHidden:!1,isLight:!1,isTransparent:!1,isUndefinedWhenDisabled:!1,label:"A select",name:"mySelect",options:g,placeholder:"Pick an option",readOnly:!1,searchable:!0,virtualized:!1},decorators:[f({box:{width:640},withBackgroundButton:!0,withNewWindowButton:!0})]};function n(r){const[t,u]=p.useState("∅"),{controlledOnChange:d,controlledValue:m}=y(r.value,u);return a.jsxs(a.Fragment,{children:[a.jsx(o,{...r,onChange:d,value:m}),t!=="∅"&&a.jsx(O,{value:t})]})}n.__docgenInfo={description:"",methods:[],displayName:"_Select",props:{customSearch:{required:!1,tsType:{name:"CustomSearch",elements:[{name:"intersection",raw:`Omit<
  ItemDataType<string>,
...
}`,...(s=(l=n.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};const x=["_Select"];export{n as _Select,x as __namedExportsOrder,k as default};
