import{b9 as p,a as g,aJ as f,j as o}from"./index-ucqKeW45.js";import{k as O}from"./index-CMZNRRAH.js";import{r}from"./index-CBqU2yxZ.js";import{O as S}from"./Output-DuOCsNck.js";import{g as Q}from"./StoryDecorator-D_ImgbCs.js";import"./isPlainObject-ByolnvGK.js";import"./_commonjsHelpers-BosuxZz1.js";import"./mapValues-y2Dgfp-9.js";import"./index-Ch9hqOxJ.js";import"./debounce-S-gaweFD.js";import"./_arrayIncludesWith-DoLrk8sb.js";import"./GlobalDecorator-BXk91z3w.js";const v={error:"",isLabelHidden:!1,isLight:!1,label:"An autocompletable select",name:"autoComplete",placeholder:'Type "brew"'},$={title:"Fields/Search",component:p,argTypes:{},args:v,decorators:[Q({hasDarkMode:!0})]};function e(i){const[t,l]=r.useState("∅"),[m,c]=r.useState([]);return g(f,{children:[o(p,{...i,onChange:l,onQuery:async d=>{const a=await O.get(`https://api.openbrewerydb.org/breweries?by_name=${d}`).json(),y=a?a.map(({id:b,name:h})=>({label:h,value:b})):[];c(y)},options:m}),t!=="∅"&&o(S,{value:t})]})}var n,s,u;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`function WithQuery(props: SearchProps) {
