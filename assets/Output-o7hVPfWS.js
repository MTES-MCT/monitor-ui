import{s as n,a as s,aJ as i,j as r}from"./index-DOn5IH5D.js";import{r as p}from"./index-CBqU2yxZ.js";function a({label:t="Output",value:e}){const o=p.useMemo(()=>e===void 0?"undefined":JSON.stringify(e,null,2),[e]);return s(i,{children:[r(u,{children:`${t} (type: ${typeof e=="object"?e.constructor.name:typeof e})`}),r(c,{className:"mui-output","data-cy":t,children:o})]})}const u=n.h3`
  font-size: 100%;
  line-height: 1.3846;
  margin: 16px 0 8px 0;
`,c=n.pre`
