import{bm as m,j as e}from"./index-0nDB5Zzz.js";import{r as t}from"./index-CBqU2yxZ.js";import{O as h}from"./Output-Sfj1QWTd.js";import{S as v,C as b}from"./species-Ckei7gAd.js";import{g}from"./generateStoryDecorator-jcZX8bPx.js";import"./_baseClone-CBkhujLI.js";import{u as y}from"./useFieldControl-oDxVSMc2.js";import"./isPlainObject-Dl0da9pc.js";import"./_commonjsHelpers-BosuxZz1.js";import"./mapValues-CZXAhdHD.js";import"./index-Ch9hqOxJ.js";import"./toNumber-BGTiNFDU.js";import"./StoryBox-BZYZ6up0.js";import"./fr_FR-CrxT__co.js";const O={disabled:!1,error:"",isErrorMessageHidden:!1,isLabelHidden:!1,isLight:!1,label:"A multiple select",name:"myMultiSelect",options:[],optionValueKey:"code",placeholder:"Pick some options",searchable:!0,value:void 0,virtualized:!0},j={title:"Fields/MultiSelect (variations)",component:m,argTypes:{value:{control:"inline-check",options:["FIRST_OPTION","SECOND_OPTION","THIRD_OPTION","LOREM_IPSUM"]}},args:O,decorators:[g({withBackgroundButton:!0})]};function n(r){const i=t.useRef(v.map(a=>({label:`${a.code} - ${a.name}`,value:a}))),d=t.useRef(new b(i.current,[{name:"value.code",weight:.9},{name:"value.name",weight:.1}],{isStrict:!0})),[l,c]=t.useState("∅"),{controlledOnChange:p,controlledValue:f}=y(r.value,c);return e.jsxs(e.Fragment,{children:[e.jsx(m,{...r,customSearch:d.current,onChange:p,options:i.current,value:f}),e.jsx("div",{children:e.jsx("em",{children:"Loads a list of 10,000 users in order to check performances."})}),l!=="∅"&&e.jsx(h,{value:l})]})}n.__docgenInfo={description:"",methods:[],displayName:"MultiSelectWithCustomSearch",props:{customSearch:{required:!1,tsType:{name:"CustomSearch",elements:[{name:"intersection",raw:`Omit<
  ItemDataType<string>,
...
}`,...(u=(s=n.parameters)==null?void 0:s.docs)==null?void 0:u.source}}};const L=["MultiSelectWithCustomSearch"];export{n as MultiSelectWithCustomSearch,L as __namedExportsOrder,j as default};
