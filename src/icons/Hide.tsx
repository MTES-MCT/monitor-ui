...
export function Hide({ color, ...nativeProps }: IconProps) {
  return (
    <IconBox color={color}>
      <svg height="20" id="Hide" viewBox="0 0 20 20" width="20" {...nativeProps}>
        <path
          ...
          data-name="Tracé 1350"
          fill="currentColor"
          id="Tracé_1350"
        />
        <rect data-name="Rectangle 6094" fill="none" height="20" id="Rectangle_6094" width="20" />
      </svg>
    </IconBox>
  )
}
