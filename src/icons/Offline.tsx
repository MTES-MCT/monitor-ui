...
export function Offline({ color, size, title, ...nativeProps }: IconProps) {
  return (
    <IconBox $color={color} $size={size} title={title}>
      <svg height="20" viewBox="0 0 20 20" width="20" {...nativeProps}>
        <defs>
          <clipPath>
            <rect fill="currentColor" height="20" stroke="currentColor" strokeWidth="1" width="20" />
          </clipPath>
          <clipPath>
            <rect height="20" width="20" />
          </clipPath>
        </defs>
        <g clipPath="url(#clip-Plan_de_travail_2)">
