...
export function SortingArrows({ color, ...nativeProps }: IconProps) {
  return (
    <IconBox color={color}>
      <svg height="20" viewBox="0 0 20 20" width="20" {...nativeProps}>
        <g id="Sorting_arrows" transform="translate(-40)">
          <g data-name="Groupe 4164" id="Groupe_4164">
            <g data-name="Tracé 1383" fill="none" id="Tracé_1383" strokeMiterlimit="10">
            ...
            <g data-name="Tracé 1384" fill="none" id="Tracé_1384" strokeMiterlimit="10">
